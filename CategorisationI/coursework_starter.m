...
% Color Spaces:
% tiny image = [ 'grayscale', 'hsv', 'ycbcr' ]
% colour histogram = [ 'rgb,', 'hsv', 'opponent' ]
colour_space = 'rgb';
...
k = 15;
% distance_metric = ['euclidean', 'cityblock', 'minkowski'...]
...
switch lower(FEATURE)    
    ...
    case 'colour histogram'
        ...
        train_image_feats = get_colour_histograms(train_image_paths, quantization_level, colour_space);
        test_image_feats  = get_colour_histograms(test_image_paths, quantization_level, colour_space);
end
...
switch lower(CLASSIFIER)    
    ...
    predicted_categories = nearest_neighbour_classify(train_image_feats, train_labels, test_image_feats, k, distance_metric);
end
